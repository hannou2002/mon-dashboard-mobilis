...
-- Chaque BTS a 3 sous-antennes (A, B, C) couvrant 120° chacune
...
CREATE TABLE IF NOT EXISTS bts_antennas (
    ...
    etatA ENUM('actif', 'inactif', 'maintenance') DEFAULT 'actif',
    etatB ENUM('actif', 'inactif', 'maintenance') DEFAULT 'actif',
    etatC ENUM('actif', 'inactif', 'maintenance') DEFAULT 'actif',
